...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div
      onClick={handleClick}
      className={`w-full p-10 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 ${colorClass} flex flex-col items-center cursor-pointer`}
    >
  ...
  const services = [
    {
      ...
      redirect: "/service/financial-advisory-services",
    },
    {
      icon: (
        <Image
      ...
      redirect: "/service/fund-portfolio-management",
    },
    {
      icon: (
        <Image
      ...
      redirect: "/service/securities-commodities-trading",
    },
    {
      icon: (
        <Image
