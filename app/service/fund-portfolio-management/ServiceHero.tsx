...
const ServiceHero: React.FC = () => {
  return (
    <div
      ...
      style={{ backgroundImage: `url(/service2.svg)` }} // Dynamically set background image
    >
      <div className="flex items-center justify-start min-h-screen md:mr-[45%] sm:mx-auto px-4 sm:px-6 md:px-10">
        <div className="bg-white p-6 md:p-8 lg:p-10 border-t border-b border-solid text-black mx-auto max-w-2xl shadow-md flex flex-col">
          ...
          <p className="text-sm md:text-sm lg:text-sm mr-4 mb-6 text-justify leading-relaxed max-w-lg">
            This unit offers wide range of products and services to enable our
            customers realize their specific investment objectives. Olive
            Capital employs a prudent, disciplined and personalized investment
            approach in handling clients portfolios
          </p>
        </div>
      </div>
    </div>
